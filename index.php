...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">FarmerCommunity &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">India<span>Mumbai</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9096630236</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:Farmer Community@gmail.com" style="color:white">gophanekunal@gamil.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About FarmerCommunity</b></span>
				FarmerCommunity is e-commerce trading platform for grains & grocerries...
			</p>
